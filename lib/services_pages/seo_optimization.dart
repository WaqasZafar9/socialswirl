...
final serviceDescriptionProvider = Provider<String>((ref) {
  return 'Harness the power of data to propel your website to the top of search engine results. Our SEO strategies are driven by in-depth analytics and industry insights, ensuring your brand stays ahead of the competition and visible to your target audience.';
});

class SeoOptimization extends ConsumerWidget {
  const SeoOptimization({super.key});
      ...
      child: Column(
        ...
        children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _buildBulletPoint(context, 'Keyword research and optimization'),
                            _buildBulletPoint(context, 'On-page and off-page SEO'),
                            if (constraints.maxHeight < imageHeight) ...[
                              // Move the remaining points below if they don't fit next to the image
                              const SizedBox(height: 16),
                              _buildBulletPoint(context, 'Technical SEO audits'),
                              _buildBulletPoint(context, 'Content strategy and creation'),
                              _buildBulletPoint(context, 'Regular performance reports'),
                            ],
                          ],
                        ),
                      ),
          ...
          _buildSection(context, 'Benefits', [
            'Increased Visibility: Boost your search engine rankings and attract more organic traffic to your website, expanding your online reach.',
            'Targeted Traffic: Reach the right audience with optimized content and keyword strategies that align with your business objectives.',
            'Higher Conversions: Drive qualified leads to your site through targeted SEO efforts, increasing conversion rates and ROI.',
            'Long-Term Results: Build a sustainable online presence with white-hat SEO techniques that adhere to search engine guidelines, ensuring lasting success.',
            'Competitive Advantage: Outrank competitors in search engine results and establish your brand as a leader in your industry.',
            'Continuous Improvement: Stay ahead of algorithm changes and industry trends with ongoing SEO audits and optimization strategies.',
          ]),
        ],
      ),
    );
