...
final serviceDescriptionProvider = Provider<String>((ref) {
  return 'Make a lasting impression with visually stunning designs that resonate with your audience on a deeper level. Our creative solutions go beyond aesthetics to evoke emotion and build meaningful connections with your brand.';
});

class Designing extends ConsumerWidget {
      ...
      child: Column(
        ...
        children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _buildBulletPoint(context, 'Custom logo design'),
                            _buildBulletPoint(context, 'Professional business card creation'),
                            if (constraints.maxHeight < imageHeight) ...[
                              // Move the remaining points below if they don't fit next to the image
                              const SizedBox(height: 16),
                              _buildBulletPoint(context, 'Standout CV designs'),
                              _buildBulletPoint(context, 'Comprehensive portfolio layouts'),
                              _buildBulletPoint(context, 'Consistent branding across all materials'),
                            ],
                          ],
                        ),
                      ),
          ...
          _buildSection(context, 'Benefits', [
            'Brand Differentiation: Stand out from the competition with visually compelling designs that capture attention and communicate your unique brand identity.',
            'Emotional Engagement: Create meaningful connections with your audience through emotive visuals and storytelling, fostering brand loyalty and advocacy.',
            'Versatility: Extend your brand\'s visual language across various touch-points, from digital platforms to print materials, for a consistent and cohesive brand experience.',
            'Increased Engagement: Drive user engagement and interaction with captivating designs that inspire action and drive conversions.',
            'Accessibility: Ensure inclusivity and accessibility with designs that prioritize user experience and usability for all individuals, regardless of abilities or devices.',
            'Innovation: Stay ahead of design trends and industry standards with innovative and creative solutions that push boundaries and captivate audiences.',
          ]),
        ],
      ),
    );
