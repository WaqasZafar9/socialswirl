...
final serviceDescriptionProvider = Provider<String>((ref) {
  return 'Navigate the complexities of digital transformation with confidence. Our consulting services offer strategic insights and actionable recommendations tailored to your unique business needs, helping you achieve sustainable growth in the digital age.';
});

class ConsultingService extends ConsumerWidget {
  const ConsultingService({super.key});
      ...
      child: Column(
        ...
        children: [
            ...
            builder: (context, constraints) {
              ...
              return Column(
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildBulletPoint(
                                context, 'Comprehensive digital strategy development'),
                            _buildBulletPoint(
                                context, 'Technology and tool recommendations'),
                            if (constraints.maxHeight < imageHeight) ...[
                              // Move the remaining points below if they don't fit next to the image
                              const SizedBox(height: 17),
                              _buildBulletPoint(
                                  context, 'Branding and positioning advice'),
                              _buildBulletPoint(
                                  context, 'Market analysis and research'),
                              _buildBulletPoint(
                                  context, 'Ongoing support and mentoring'),
                            ],
                          ],
                        ),
                      ),
                  ...
                  if (constraints.maxHeight >= imageHeight) ...[
                    const SizedBox(height: 16),
                    _buildBulletPoint(context, 'Branding and positioning advice'),
                    _buildBulletPoint(context, 'Market analysis and research'),
                    _buildBulletPoint(context, 'Ongoing support and mentoring'),
                  ],
                ],
              );
            },
          ...
          _buildSection(context, 'Benefits', [
            'Strategic Guidance: Receive expert advice and strategic direction to navigate complex business challenges and capitalize on opportunities.',
            'Customized Solutions: Access tailored recommendations and solutions designed to address your specific business needs and goals.',
            'Industry Insights: Benefit from our deep industry expertise and market knowledge, gaining valuable insights to stay ahead of the competition.',
            'Risk Mitigation: Identify potential risks and pitfalls early on, mitigating threats to your business and ensuring long-term success.',
            'Cost Savings: Avoid costly mistakes and wasted resources with efficient and effective strategies developed by experienced consultants.',
            'Empowerment: Equip your team with the knowledge and tools they need to drive business growth and innovation independently.',
          ]),
        ],
      ),
    );
